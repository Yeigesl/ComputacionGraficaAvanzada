...
glm::mat4 modelMatrixDart = glm::mat4(1.0);
...
void applicationLoop() {
	...
	modelMatrixAircraft = glm::translate(modelMatrixAircraft, glm::vec3(10.0, 5.0, -17.5));

	modelMatrixLambo = glm::translate(modelMatrixLambo, glm::vec3(23.0, 0.0, 0.0));

	modelMatrixDart = glm::translate(modelMatrixDart, glm::vec3(23.0f, 0.0f, 0.0f));
